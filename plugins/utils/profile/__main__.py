...
async def view_profile(message: Message):
    ...
    if "-fname" in message.flags:
        ...
        await message.edit(
            f"<code>{first_name}</code>", parse_mode=enums.ParseMode.HTML
        )
    elif "-lname" in message.flags:
        if not user.last_name:
            ...
            await message.edit(
                f"<code>{last_name}</code>", parse_mode=enums.ParseMode.HTML
            )
        ...
        if not user.last_name:
            ...
            await message.edit(
                f"<code>{full_name}</code>", parse_mode=enums.ParseMode.HTML
            )
        ...
        if not user.username:
            ...
            await message.edit(
                f"<code>{username}</code>", parse_mode=enums.ParseMode.HTML
            )
